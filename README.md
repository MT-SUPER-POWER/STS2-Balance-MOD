...
| **能量汲取** | 骨妹 | 造成 10/12 伤害，升级后“随机升级 3 张” | 造成 **6/8 伤害**，升级后**升级弃牌堆的所有牌** |
| **吸引仇恨** | 骨妹 | 升级后原版数值 | 升级后调整为：**召唤 6，格挡 9** |
...
| 卡牌 | 角色 | 描述 |
|------|------|------|
| **比试** | 骨妹 | 造成 8 点伤害，且奥斯提造成 7/9（升级）点伤害；实际造成的非格挡伤害较少的一方回复 4/6 点生命。并消耗。 |
| **猛撞** | 骨妹 | 仅在奥斯提拥有至少 5 点生命时可用。奥斯提失去 6/5（升级）点生命，对所有敌人造成 20/26 点伤害。（卡图未完成） |
| **步步为营** | 猎人 | X 费，打出这张牌后的 X 回合，获得 1 点额外能量和 1 抽牌，消耗。 |
