...
| **心灵绽放 [Mind Bloom]** | Act 3 | 1. **战斗**——随机挑战本局第一幕原版 Boss，胜利获得 50 金 + 稀有遗物；奖励结算后返回事件，可带着奖励离开。第一战及预留的往昔 Boss 第二战遭遇均登记为事件战斗，并在怪物图鉴「事件」分组显示其可能怪物；第二战在追加奖励与随机强化规则确认前不会显示继续挑战选项。<br>2. **升级**——升级牌组中所有可升级的牌，并获得 <img src="Assets/relics/mark_of_the_bloom.png" width="18" height="18" valign="middle"> **「绽放印记」** 遗物。<br>3. **宝库**（层数 < 41，多人 < 38）获得 999 金 + 牌组加入 2 张「凡庸」。|
