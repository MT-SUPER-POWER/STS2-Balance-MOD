...
using Sts2BalanceMod.src.Runtime.Animations;
...
/// </summary>
[RegisterMonster]
public sealed class AcidSlimeMedium : BalanceMonsterTemplate
{
  ...
  public override MonsterAssetProfile AssetProfile => new(
    ModAssetPaths.Resource("monsters", "acid_slime_medium", "acid_slime_medium.tscn"));
