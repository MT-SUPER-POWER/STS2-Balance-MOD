...
internal static class CustomRestSiteOptionButtonPatch
{
  ...
  {
    if (OptionRef(__instance) is not Sts2RestSiteOption option)
    {
      return true;
    }
    ...
    // NOTE: 原版 RestSiteOption.Icon 使用私有硬编码路径 res://images/ui/rest_site。
    // Mod pck 中的资源位于 res://Sts2BalanceMod/images，因此自定义选项必须在这里接管刷新。
