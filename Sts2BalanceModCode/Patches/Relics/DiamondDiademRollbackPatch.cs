...
public static class DiamondDiademRollbackPatch
{
  ...
  private static readonly ConditionalWeakTable<DiamondDiadem, TurnState> _turnStates = [];
  ...
  private static bool ShouldHalveEnemyDamage(DiamondDiadem relic, Creature target, Creature dealer)
  {
    ...
    return _turnStates.TryGetValue(relic, out TurnState? state) && state.HalveEnemyDamage;
  }
}
