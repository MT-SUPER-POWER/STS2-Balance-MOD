...
public static class FuelDrawPatch
{
  ...
  [HarmonyPrefix]
  public static bool Prefix(Fuel __instance, PlayerChoiceContext choiceContext, ref Task __result)
  {
  ...
  private static async Task OnPlay(Fuel __instance, PlayerChoiceContext choiceContext)
  {
