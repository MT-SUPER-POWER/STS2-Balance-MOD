...
namespace Sts2BalanceMod.Sts2BalanceModCode.Patches.Localization;

/// <summary>
/// 将 MOD 的 enchantments.json 翻译注入到 LocManager 的 enchantments 表中。
/// 与 MonsterLocalizationInjectionPatch 同理，BaseLib 不会自动加载自定义本地化表。
/// </summary>
...
public static class EnchantmentLocalizationInjectionPatch
{
  ...
  private static void Postfix(string name, ref LocTable __result)
  {
    ...
    try
    {
      ...
      var path = $"res://Sts2BalanceMod/localization/{lang}/enchantments.json";
