...
{
  private static readonly MethodInfo SetEventFinishedMethod = AccessTools.Method(typeof(EventModel), "SetEventFinished", [typeof(LocString)]);
  ...
  public static class BugslayerPatch
  {
    ...
    private static void Postfix(Bugslayer __instance, ref IReadOnlyList<EventOption> __result)
    {
      ...
      async Task leaveAction()
      {
        SetEventFinishedMethod.Invoke(__instance, [new LocString("events", "BUGSLAYER.pages.LEAVE.description")]);
  ...
  public static class TinkerTimePatch
  {
    ...
    private static void Postfix(TinkerTime __instance, ref IReadOnlyList<EventOption> __result)
    {
      ...
      async Task leaveAction()
      {
        SetEventFinishedMethod.Invoke(__instance, [new LocString("events", "TINKER_TIME.pages.LEAVE.description")]);
        await Task.CompletedTask;
      }
  ...
  public static class TheFutureOfPotionsPatch
  {
    ...
    private static void Postfix(TheFutureOfPotions __instance, ref IReadOnlyList<EventOption> __result)
    {
      ...
      async Task leaveAction()
      {
        SetEventFinishedMethod.Invoke(__instance, [new LocString("events", "THE_FUTURE_OF_POTIONS.pages.LEAVE.description")]);
        await Task.CompletedTask;
      }
