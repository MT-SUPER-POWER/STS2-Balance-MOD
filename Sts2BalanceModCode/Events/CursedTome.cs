...
public sealed class CursedTome : BalanceEventTemplate
{
  ...
  private const int _dmgPage1 = 1;
  private const int _dmgPage2 = 2;
  private const int _dmgPage3 = 3;
  private const int _dmgStop = 3;
  private const int _dmgObtain = 15;
  ...
  [
    new IntVar("DmgPage1", _dmgPage1),
    new IntVar("DmgPage2", _dmgPage2),
    new IntVar("DmgPage3", _dmgPage3),
    new IntVar("DmgStop", _dmgStop),
    new IntVar("DmgObtain", _dmgObtain),
  ];
