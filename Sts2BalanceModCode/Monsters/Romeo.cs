...
public sealed class Romeo : BalanceMonsterTemplate
{
  ...
  public override async Task AfterAddedToRoom()
  {
    ...
    Creature? bear = combatState.GetTeammatesOf(Creature)
  ...
  {
    bool bearAlive = Creature.CombatState?.GetTeammatesOf(Creature)
      .Any(t => t != Creature && t.IsAlive && t.Monster is Bear) == true;
    LocString line = bearAlive ? MockBearAliveLine : MockBearDeadLine;
