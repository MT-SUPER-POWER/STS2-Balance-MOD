...
/// <summary>
/// 分裂后产生的尖刺中号史莱姆。参考 ActsFromThePast 的 SpikeSlimeMedium。
/// </summary>
public sealed class SpikeSlimeMedium : Sts2MonsterModel
{
  private const string FlameTackle = "FLAME_TACKLE";
  private const string Lick = "LICK";

  protected override string VisualsPath =>
    "res://Sts2BalanceMod/monsters/spike_slime_medium/spike_slime_medium.tscn";

  public override int MinInitialHp => 30;
  public override int MaxInitialHp => 34;

  private const int FlameTackleDamage = 10;
