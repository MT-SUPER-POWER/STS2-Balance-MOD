...
public sealed class Sparring : BalanceCardTemplate
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    if (Owner.IsOstyAlive && Owner.Osty != null)
    {
      ...
      AttackCommand ostyResult = await DamageCmd.Attack(DynamicVars.OstyDamage.BaseValue)
    ...
    AttackCommand playerResult = await DamageCmd.Attack(DynamicVars.Damage.BaseValue)
