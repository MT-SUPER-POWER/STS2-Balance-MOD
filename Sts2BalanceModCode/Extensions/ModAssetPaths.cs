...
public static class ModAssetPaths
{
  ...
  public static string Resource(params string[] segments) => Root + "/" + string.Join('/', segments);
  ...
  public static string ContentFileName(string publicEntry)
  {
    ...
    string stem = publicEntry.StartsWith(legacyPrefix, StringComparison.OrdinalIgnoreCase)
