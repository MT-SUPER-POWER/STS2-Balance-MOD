...
/// </summary>
[RegisterRelic(typeof(SharedRelicPool), FullPublicEntry = "STS2_BALANCEMOD_ORANGE_PILL")]
public sealed class OrangePill : BalanceRelicTemplate
{
  ...
  private bool HasAllThreeTypesPlayed() => IsAttackPlayed && IsSkillPlayed && IsPowerPlayed;

  private bool HasAnyTypePlayed() => IsAttackPlayed || IsSkillPlayed || IsPowerPlayed;
