...
public sealed class LightFlareParticleEffect : NSts1Effect, IDisposable
{
  ...
  protected override void Initialize()
  {
    ...
    LibGdxAtlas.TextureRegion? textureRegion = LibGdxAtlas.GetRegion(AtlasPath, BlurRegion);
