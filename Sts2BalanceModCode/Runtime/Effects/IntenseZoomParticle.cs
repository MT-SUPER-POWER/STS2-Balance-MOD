...
/// </summary>
public sealed class IntenseZoomParticle : NSts1Effect, IDisposable
{
  ...
  protected override void Initialize()
  {
    ...
    LibGdxAtlas.TextureRegion? textureRegion = LibGdxAtlas.GetRegion(AtlasPath, coneName);
  ...
  protected override void Update(float delta)
  {
    ...
    Color color = _isBlack ? Colors.Black : new Color(0.937f, 0.808f, 0.373f);
  ...
  private void RandomizeParticle()
  {
    ...
    float fade = 1f - (1f - Duration / EffectDuration) * (1f - Duration / EffectDuration);
