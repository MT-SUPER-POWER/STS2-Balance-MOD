...
namespace Sts2BalanceMod.Sts2BalanceModCode.RestSite;
...
/// </summary>
public abstract class Sts2RestSiteOption : RestSiteOption
{
  protected Sts2RestSiteOption(Player owner) : base(owner)
  {
  }
  ...
  /// </summary>
  public virtual string CustomIconPath => $"option_{OptionId.ToLowerInvariant()}.png".RestSiteOptionImagePath();
