...
wget -q --tries=3 "https://github.com/godotengine/godot/releases/download/${GODOT_VERSION}-stable/Godot_v${GODOT_VERSION}-stable_mono_linux_x86_64.zip"
...
rm -f "Godot_v${GODOT_VERSION}-stable_mono_linux_x86_64.zip"

# 2. 下载并安装导出模板（导出 PCK 所需）
wget -q --tries=3 "https://github.com/godotengine/godot/releases/download/${GODOT_VERSION}-stable/Godot_v${GODOT_VERSION}-stable_mono_export_templates.tpz"
...
rm -rf /tmp/templates "Godot_v${GODOT_VERSION}-stable_mono_export_templates.tpz"
