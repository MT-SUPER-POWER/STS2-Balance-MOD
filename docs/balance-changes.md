...
- [x] CARD-08 — 袖里乾坤定位和刀舞冲突，暂时删除
  - [ ] TODO: 由于定位冲突，如何修改这个牌的效果呢
...
- [x] STS1-EVENT-06 — 移植心灵绽放事件
- [x] STS1-EVENT-07 — 移植大转盘事件
  - [x] 自定义转盘 UI
...
- [x] RELIC-10 — 商店遗物-矮人铁砧: 你可以选择一张 攻击 / 技能牌在火堆处不断升级(附魔效果)
...
- [ ] BUG-06 — 改版的沙漏的凋零产生效果不会保留虽然有保留词条，还是会进入弃牌堆     // DEPRECATED: 这个 BOSS 已经删除了
...
- [x] BUG-12 — 面具强盗事件注册的遭遇战，事件版本的遇不到了

## FEATURE 列表

- [ ] FEATURE-01 — 游戏里没有宝箱跳过的选项，那么多人完全不知道如何做，所以**诅咒钥匙**现在基本就是拿了稳定三诅咒的
- [x] FEATURE-02 — 时间老头在多人战斗过于恐怖，如何平衡设计是一个问题
- [x] FEATURE-03 — 时间吞噬者 BGM 体系改女王的，取消现有的注入机制
