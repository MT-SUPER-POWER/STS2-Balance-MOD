...
- [ ] RELIC-08 — 红面具从一般遗物获取池移除，只通过红面具相关事件获得
...
- [ ] STS1-BOSS-01 — 移植时间吞噬者 Boss（Time Eater，对应 MON-02）
- [ ] STS1-BOSS-02 — 移植收藏家 Boss（Collector）
- [ ] STS1-EVENT-01 — 移植诅咒书本事件（可获得死灵之书、尼利的宝典、英雄宝典）
- [ ] STS1-EVENT-02 — 移植红面具事件（Masked Bandits，含红面具帮战斗）
- [ ] STS1-EVENT-03 — 移植增益研究者事件（J.A.X. 事件）
- [ ] STS1-EVENT-04 — 移植神圣泉水事件（删除诅咒）
- [ ] STS1-EVENT-05 — 移植牧师事件（治疗 / 删牌）
- [ ] STS1-EVENT-06 — 移植心灵绽放事件（999 金币打一层 Boss / 获得绽放印记后不能再回复）
- [ ] STS1-EVENT-07 — 移植大转盘事件
- [ ] STS1-EVENT-08 — 移植红面具大人之墓事件（获得红面具 / 戴上红面具）
- [ ] STS1-CARD-01 — 合并本批事件依赖卡牌（J.A.X.、死灵诅咒）
- [ ] STS1-RELIC-01 — 合并本批事件依赖遗物（死灵之书、尼利的宝典、英雄宝典、绽放印记等；红面具使用二代已有遗物）
- [ ] STS1-ACT-01 — 本批一代回归内容先简单注入，不规划二层/三层新区域；后续区域方案另行规划
