...
- [ ] STS1-BOSS-01 — 移植时间吞噬者 Boss（对应 MON-02）
- [ ] STS1-EVENT-01 — 调整双拳机器人事件血量（对应 EVENT-01）
- [ ] STS1-CARD-01 — 评估并合并一代事件卡/诅咒候选（死灵诅咒、疼痛、寄生等）
- [ ] STS1-RELIC-01 — 评估并合并一代事件遗物候选（金神像、死灵之书、尼利的宝典等）
- [ ] STS1-EVENT-02 — 选择 2-3 个轻量一代事件作为试点
- [ ] STS1-ACT-01 — 暂缓完整一代三幕/普通怪/遭遇池移植，另开里程碑
