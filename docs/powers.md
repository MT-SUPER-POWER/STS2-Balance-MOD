...
| <img src="../Sts2BalanceMod/images/powers/WitchFormPower.png" width="22" height="22" valign="middle"> | **女巫形态 [Witch Form]** | `WitchFormPower`<br>`STS2_BALANCE_MOD_POWER_WITCH_FORM_POWER` | 先古卡「女巫形态」（遗物「精致的玩偶」/ Tanx 事件，可在 Mod 设置中开关） | 回合开始将手牌中 2 张牌分别蜕变为升级后的「巫术打击+」与「巫术防御+」（无额外抽牌）。 |
...
| <img src="../Assets/powers/sorcery_weak.png" width="22" height="22" valign="middle"> | **巫术虚弱 [Sorcery Weak]** | `SorceryWeak`<br>`STS2BALANCEMOD-SORCERY_WEAK` | 先古卡「巫术防御」（探克斯 Tanx） | 造成的攻击伤害减少 **40%**。若本回合进行过攻击，回合结束时减少 1 层。 |
...
| **冷却剂 [Coolant Power]** | <img src="../Assets/profile/defect.png" width="18" height="18"> 故障机器人能力卡「冷却剂」 | 在你的回合开始时，你每有一种不同的充能球，就获得 2/3 点格挡。 | 屏蔽充能球格挡逻辑，重做为**能力抽牌引擎**：每当你打出一张能力牌，抽 **{Amount}** 张牌。 |
